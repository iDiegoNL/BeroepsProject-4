        ...
        <div class="widget w-birthday-alert">
            ...
            <div class="content">
                <div class="author-thumb">
                    <img src="https://images.reverb.com/image/upload/s--KlS0EWcP--/f_auto,t_large/v1541180191/buml9whkchiukfr4jrvm.jpg" alt="author">
                </div>
                <span>Your next event is</span>
                <a href="#" class="h4 title">Tomorrow</a>
                <p>You can find your tickets on your purchases page.</p>
            </div>
        </div>
    ...
    <div class="ui-block">
        ...
        <ul class="widget w-activity-feed notification-list">
            <li>
                ...
                <div class="notification-event">
                    <a href="#" class="h6 notification-friend">Marina Polson</a> commented on Jason Mark’s <a href="#"
            ...
            <li>
                ...
                <div class="notification-event">
                    <a href="#" class="h6 notification-friend">Jake Parker </a> liked Nicholas Grissom’s <a href="#"
            ...
            <li>
                ...
                <div class="notification-event">
                    <a href="#" class="h6 notification-friend">Mary Jane Stark </a> added 20 new photos to her <a
                            href="#" class="notification-link">gallery album.</a>.
            ...
            <li>
                ...
                <div class="notification-event">
                    <a href="#" class="h6 notification-friend">Nicholas Grissom </a> updated his profile <a href="#"
                                                                                                            class="notification-link">photo</a>.
            ...
            <li>
                ...
                <div class="notification-event">
                    <a href="#" class="h6 notification-friend">Marina Valentine </a> commented on Chris Greyson’s <a
            ...
            <li>
                ...
                <div class="notification-event">
                    <a href="#" class="h6 notification-friend">Elaine Dreyfuss </a> commented on your <a href="#"
                                                                                                         class="notification-link">blog
                        post</a>.
                    <span class="notification-date"><time class="entry-date updated" datetime="2004-07-24T18:18">2 hours ago</time></span>
                </div>

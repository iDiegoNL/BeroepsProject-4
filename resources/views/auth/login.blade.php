                            ...
                            <div class="row">
                                <div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="remember">
                                        ...
                                        <a href="#" class="forgot" data-toggle="modal" data-target="#restore-password">Forgot
                                            my Password</a>
                                    </div>
                                    ...
                                    <a href="#" class="btn btn-lg bg-spotify full-width btn-icon-left"><i
                                                class="fab fa-spotify" aria-hidden="true"></i>Log in with Spotify</a>

                                    <a href="#" class="btn btn-lg bg-soundcloud full-width btn-icon-left"><i
                                                class="fab fa-soundcloud" aria-hidden="true"></i>Log in with
                                        SoundCloud</a>
